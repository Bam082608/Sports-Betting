...
## Key Advantage: Double Star

> *Dallas has TWO Tier 1 stars - bet both every game*

This is rare. Most teams have one concentration player. Dallas has two, which doubles our edge when they play.
...
| **Average SOG** | 3-4 |
| **Role** | PP1 |
| **Best Use** | Cross-game parlays |

- Excellent for cross-game D-men parlays
- PP1 usage = consistent opportunities
- Use Tier B stakes ($1.25)

---

## Key Patterns

1. **Double Tier 1** - Rare advantage, maximize exposure
...
When Dallas plays, build:
- **Ticket 1:** Robertson 2P SOG
- **Ticket 2:** Robertson 3P SOG
- **Ticket 3:** Hintz 2P SOG
- **Ticket 4:** Hintz 3P SOG
- **Ticket 5:** Heiskanen in cross-game parlay
...
*APEXVIPER Rating: ⭐⭐⭐⭐⭐ (5/5) - DOUBLE Elite betting target*
